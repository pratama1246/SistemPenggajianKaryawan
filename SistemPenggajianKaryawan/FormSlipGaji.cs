...
namespace SistemPenggajianKaryawan
{
    public partial class FormSlipGaji : Form
    {
        ...
        private void TampilkanSlip(int karId, int bulan, int tahun)
        {
            ...
            string qAbs = "SELECT hadir, izin, sakit, alpha, lembur FROM absensi WHERE karyawan_id = @id AND bulan = @bulan AND tahun = @tahun";
            ...
            DataTable dtComp = server.eksekusiQuery("SELECT nama_komponen, tipe, jenis_nilai, nilai, berlaku_untuk FROM komponengaji");
